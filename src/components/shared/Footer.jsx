export default function Footer() {
  return (
    <footer className="bg-[#0D1F4E] border-t border-color-gold border-opacity-20 py-12 md:py-16">
      <div className="max-w-6xl mx-auto px-6">
        {/* Logo and Company Name Section */}
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-10 pb-10 border-b border-color-gold border-opacity-30">
          <img
